...
import { createSendTodoSessionSchema, sendTodoSchema, validSendTodoSessionSchema } from '../schema/sendTodo.schema'
...
export const initSendTodoRoute = (connector: ITodoConnector) => {
    ...
    router.post('/', authorization, valdiation(createSendTodoSessionSchema), controller.createSendTodoSessionHandler)
